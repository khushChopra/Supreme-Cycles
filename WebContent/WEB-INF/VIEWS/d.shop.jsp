...
<jsp:include page="CSS/CustHeader.jsp" />
    ...
    <div class="container"> 
      ...
      <c:forEach items="${AccessoryList}" var="item">
    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
      <h4 class="display-4">Cycles</h4>
    </div>

    <div class="container"> 
      <div class="card-deck mb-6 text-center">   
      
      <c:forEach items="${Cycle_modelList}" var="item">
        ...
        <div class="card mb-4 box-shadow">
          ...
          <div class="card-body">
            ...
            <a type="button" class="btn btn-lg btn-block btn-primary" href="cycle_model/${item.model_code}">Add to cart</a>
          </div>
        </div>
