    ...
    <div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
      <header class="masthead mb-auto">
        <div class="inner">
          <nav class="nav nav-masthead justify-content-center">
            <a class="nav-link " href="/Website_1/">Login</a>
			<a class="nav-link active" href="/Website_1/register">Register</a>
      ...
      <main role="main" class="inner cover">
        ...
        <div class="col-md-12 ">
		   ...
		   <form action="/Website_1/register" method="post" modelAttribute="user">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="address" id="address" required class="form-control" placeholder="Complete address">
            </div>
            
            <div class="mb-3">
              <label for="email">Email</label>
              <input type="text" name="email" id="email" required class="form-control" placeholder="Email-ID">
            </div>
